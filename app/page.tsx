...
function Header({onMenu,onBack,back=false}: {onMenu:()=>void;onBack:()=>void;back?:boolean}) {
  return <header className="topbar"><button className="round coral" onClick={onMenu} aria-label="Deschide meniul">☰</button>{back&&<button className="round" onClick={onBack} aria-label="Înapoi">‹</button>}<div className="brand"><b>OCHIOMETRIC</b><small>ESTIMĂRI ZILNICE</small></div><button className="round settings" aria-label="Setări">☼</button></header>;
}
